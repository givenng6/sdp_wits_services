...
class _AddPostState extends State<AddPost> {
  ...
  post() async {
    ...
    if (image != null) {
      ...
      task.whenComplete(() async {
        ...
        await http.post(Uri.parse("${uri}addEvent"),
            headers: <String, String>{
              "Accept": "application/json",
              "Content-Type": "application/json; charset=UTF-8",
            },
            body: jsonEncode(<String, Map>{'event': event})).then((_) => Get.back());
      });
    }
    else{
      Map<String, dynamic> event = {
  ...
  List<String> types = ['Sports', 'Religion', 'Party'];
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              if (setTime != null) {
                                // update time
                                setState(() {
                                  time = "${setTime.hour.toString().padLeft(2, '0')}:${setTime.minute.toString().padLeft(2, '0')}";
                      ...
                      child: ElevatedButton(
                        onPressed: isButtonEnabled
                            ? () {
                                title = title.trim();
                                venue = venue.trim();
                                if (title.isNotEmpty && venue.isNotEmpty && value!=null && date.isNotEmpty && time.isNotEmpty) {
                                  setState(() {
                                    postButtonChild =
                                  ...
                                  Get.snackbar('Error', 'Fill in all required information',
